...
def summarize_for_json(summary: dict[str, object]) -> dict[str, object]:
    ...
    representative_compact = {
        ...
        "rho_tf_kinetic": representative.get("rho_tf_kinetic", np.nan),
        "rho_tf_minus_gamma_kinetic": representative.get("rho_tf_minus_gamma_kinetic", np.nan),
        "rho_tf_abs_error": representative.get("rho_tf_abs_error", np.nan),
        "rho_tf_rel_error": representative.get("rho_tf_rel_error", np.nan),
        "rho_vw_kinetic": representative.get("rho_vw_kinetic", np.nan),
        "rho_vw_kinetic_gradient": representative.get("rho_vw_kinetic_gradient", np.nan),
        "rho_vw_kinetic_form_gap": representative.get("rho_vw_kinetic_form_gap", np.nan),
        "rho_vw_minus_gamma_kinetic": representative.get("rho_vw_minus_gamma_kinetic", np.nan),
        "rho_vw_abs_error": representative.get("rho_vw_abs_error", np.nan),
        "rho_vw_rel_error": representative.get("rho_vw_rel_error", np.nan),
        "rho_ge2_kinetic": representative.get("rho_ge2_kinetic", np.nan),
        "rho_ge2_minus_gamma_kinetic": representative.get("rho_ge2_minus_gamma_kinetic", np.nan),
        "rho_ge2_abs_error": representative.get("rho_ge2_abs_error", np.nan),
        "rho_ge2_rel_error": representative.get("rho_ge2_rel_error", np.nan),
        "rho_ge4_kinetic": representative.get("rho_ge4_kinetic", np.nan),
        "rho_ge4_minus_gamma_kinetic": representative.get("rho_ge4_minus_gamma_kinetic", np.nan),
        "rho_ge4_abs_error": representative.get("rho_ge4_abs_error", np.nan),
        "rho_ge4_rel_error": representative.get("rho_ge4_rel_error", np.nan),
